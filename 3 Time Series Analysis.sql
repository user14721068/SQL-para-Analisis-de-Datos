...
select a.sales_month, a.kind_of_business, a.sales, b.ventas_totales_mes, 100 * a.sales / b.ventas_totales_mes as pct_ventas_totales
...
/*SELF JOIN*/
select a.anio, a.sales_month, a.kind_of_business, a.sales,  b.ventas_anuales, 100 * a.sales / b.ventas_anuales as pct_ventas
from
...
from 
	...
	from serie_de_tiempo.retail_sales
	where kind_of_business IN ('Men\'s clothing stores','Women\'s clothing stores')
	group by anio_venta,kind_of_business) as A;
/*
